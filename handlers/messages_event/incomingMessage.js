...
export default {
	async handler(message, client, cmds, store, user) {
		...
		(await import('../game_handlers/tebakGambar.js')).default.handler(message, client, message);
		(await import('../game_handlers/sambungKata.js')).default.handler(message, client, message);
