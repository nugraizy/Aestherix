...
export default {
	async handler(message, client, cmds, store, user) {
		...
		if (message.messages[0] && 'messageStubParameters' in message.messages[0]) {
			return (await import('./stub-message.js')).default.handler(client, message.messages[0], store);
		}
		...
		if (configuration.OPTIONS.offline) {
			...
			(await import('./offline-message.js')).default.handler(client, message);
		}
		...
		(await import('../game_handlers/akinator.js')).default.handler(message, client, message);
		(await import('../game_handlers/tebak-gambar.js')).default.handler(message, client, message);
		(await import('../game_handlers/sambung-kata.js')).default.handler(message, client, message);
		(await import('../game_handlers/wordle.js')).default.handler(message, client, message);
		(await import('./anonymous-message.js')).default.handler(message, client);
		(await import('../misc/group-url.js')).default.handler(message, client);
		(await import('../misc/anti-nsfw.js')).default.handler(message, client, message);
	},
};
