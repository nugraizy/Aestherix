...
export default {
	...
	async run({ from, message }, client) {
		...
		if (typeof searching == 'object' && searching.partner2) {
			...
			client[botNum].reply({ quoted: searching.messages1, from: searching.partner1 }, 'Your partner is found!');
			client[botNum].reply({ quoted: searching.messages2, from: searching.partner2 }, 'Your partner is found!');
