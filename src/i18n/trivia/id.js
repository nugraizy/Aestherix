export default /** @type {const} */ ({
	errors: {
		...
		noActiveGame: 'Tidak ada game trivia aktif. Buat dengan *{prefix}trivia new*',
		...
		hostCannotLeave: 'Host tidak bisa keluar. Hapus game dengan *{prefix}trivia del*',
	...
	game: {
		...
		joinPrompt: 'Ketik *{prefix}trivia join* untuk bergabung!',
		startPrompt: 'Ketik *{prefix}trivia start* untuk memulai!',
		questionHeader: '*Pertanyaan {0}/{1}*',
		questionHint: '💡 Balas dengan *{prefix}trivia <1-4>* atau *{prefix}trivia a/b/c/d*',
	...
	info: {
		...
		commands: '*Perintah:*',
		newGame: '• *{prefix}trivia new* — Membuat game baru',
		joinGame: '• *{prefix}trivia join* — Bergabung dalam permainan',
		startGame: '• *{prefix}trivia start* — Memulai permainan (khusus host)',
		startCategory: '• *{prefix}trivia start <category>* — Memulai dengan kategori tertentu',
		answer: '• *{prefix}trivia <1-4>* atau *{prefix}trivia ad* — Jawab pertanyaan',
		scores: '• *{prefix}skor trivia* — Tampilkan papan skor',
		categories: '• *{prefix}trivia kategori* — Daftar kategori',
		stopGame: '• *{prefix}trivia stop* — Mengakhiri permainan lebih awal (khusus tuan rumah)',
		deleteGame: '• *{prefix}trivia del* — Menghapus game (khusus host)',
		scoring: '*Skor:*',
		...
		step1: '1. Buat: *{prefix}trivia baru*',
		step2: '2. Yang lain bergabung: *{prefix}trivia bergabung*',
		step3: '3. Pembawa acara dimulai: *{prefix}trivia start*',
		step4: '4. Jawab dengan cepat: *{prefix}trivia 1* atau *{prefix}trivia a*'
	},
	categories: {
		SCIENCE: 'Sains',
		HISTORY: 'Sejarah',
