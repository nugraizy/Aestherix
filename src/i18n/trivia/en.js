export default /** @type {const} */ ({
	errors: {
		...
		noActiveGame: 'No trivia game active. Create one with *!trivia new*',
	...
	game: {
		...
		joinPrompt: 'Type *!trivia join* to join!',
		startPrompt: 'Type *!trivia start* to begin!',
		questionHeader: '*Question {0}/{1}*',
		questionHint: '💡 Reply with *!trivia <1-4>* or *!trivia a/b/c/d*',
	...
	info: {
		...
		commands: '*Commands:*',
		newGame: '• *!trivia new* — Create a new game',
		joinGame: '• *!trivia join* — Join the game',
		startGame: '• *!trivia start* — Start the game (host only)',
		startCategory: '• *!trivia start <category>* — Start with specific category',
		answer: '• *!trivia <1-4>* or *!trivia a-d* — Answer question',
		scores: '• *!trivia scores* — Show scoreboard',
		categories: '• *!trivia categories* — List categories',
		stopGame: '• *!trivia stop* — End game early (host only)',
		deleteGame: '• *!trivia del* — Delete game (host only)',
		scoring: '*Scoring:*',
		...
		step1: '1. Create: *!trivia new*',
		step2: '2. Others join: *!trivia join*',
		step3: '3. Host starts: *!trivia start*',
		step4: '4. Answer quickly: *!trivia 1* or *!trivia a*'
	},
	categories: {
		SCIENCE: 'Science',
		HISTORY: 'History',
