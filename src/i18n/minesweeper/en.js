export default /** @type {const} */ ({
	...
	info: {
		...
		commands: '*Commands:*',
		newGame: '• *!ms new* or *!ms easy* — Start easy game (9x9, 10 mines)',
		mediumGame: '• *!ms medium* — Start medium game (16x16, 40 mines)',
		hardGame: '• *!ms hard* — Start hard game (16x30, 99 mines)',
		reveal: '• *!ms r <cell>* — Reveal a cell (e.g., !ms r A1)',
		flag: '• *!ms f <cell>* — Toggle flag on cell',
		status: '• *!ms status* — Show game status',
		deleteGame: '• *!ms del* — Delete current game',
		howToPlay: '*How to play:*',
		step1: '1. Start game: *!ms new*',
		step2: '2. Reveal cells: *!ms r A1*',
		step3: '3. Flag suspected mines: *!ms f B2*',
