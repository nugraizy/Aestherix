export default /** @type {const} */ ({
	...
	info: {
		...
		commands: '*Perintah:*',
		newGame: '• *{prefix}ms new* atau *{prefix}ms easy* — Mulai game mudah (9x9, 10 tambang)',
		mediumGame: '• *{prefix}ms medium* — Mulai game sedang (16x16, 40 tambang)',
		hardGame: '• *{prefix}ms hard* — Mulai game sulit (16x30, 99 tambang)',
		reveal: '• *{prefix}ms r <sel>* — Buka sel (contoh: {prefix}ms r A1)',
		flag: '• *{prefix}ms f <sel>* — Toggle bendera pada sel',
		status: '• *{prefix}ms status* — Tampilkan status game',
		deleteGame: '• *{prefix}ms del* — Hapus game',
		howToPlay: '*Cara bermain:*',
		step1: '1. Mulai game: *{prefix}ms new*',
		step2: '2. Buka sel: *{prefix}ms r A1*',
		step3: '3. Beri bendera pada tambang: *{prefix}ms f B2*',
