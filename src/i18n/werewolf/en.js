export default /** @type {const} */ ({
	...
	"errors": {
		...
		"protected": "You tried to kill a guarded player. Your identity might have been exposed — lie convincingly if anyone accuses you!",
		"protectedMessage": "A wolf tried to kill you tonight, but the Guard protected you. You are safe for now — stay alert!",
		"wrongKillProtected": "Werewolf {0} tried to kill you, but since you were being guarded, you survived. Stay alert for the next night.",
	...
	"lynchNoOne": [
		"No one voted. If this happens 3 times in a row the game will end."
	],
	"roleDialogue": {
		...
		"alpha-werewolf": "You are the Alpha Werewolf. In addition to hunting with the pack, once per game you may convert a Villager into a Werewolf.",
		"seer": "You are the Seer. Each night you may inspect one player to learn whether they are a Werewolf.",
		"guard": "You are the Guard. Each night you may protect one player from a Werewolf kill. You cannot guard the same player two nights in a row, and you cannot guard yourself.",
		"witch": "You are the Witch. Once per game you may save the wolves' victim (heal), and once per game you may poison anyone (poison).",
		...
		"little-girl": "You are the Little Girl. You may peek at the Werewolves' chat at night, but there is a 25% chance they catch and kill you.",
