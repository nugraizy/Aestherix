/**
 * Werewolf — Indonesian string table.
 *
 * Strings preserved as-is from the legacy WEREWOLF_SCRIPTING where they
 * already existed, extended with entries for the six roles added in the
 * rewrite (alpha-werewolf, witch, hunter, cupid, little-girl, jester).
 */
...
export default {
	...
	help: 'Cara bermain Werewolf:\n• .ww newGame — buat lobby\n• .ww join — gabung ke lobby\n• .ww start — mulai permainan (hanya room master)\n• .ww exit — keluar (hanya saat lobby)\n• .ww delete — hapus sesi (hanya saat lobby)\n• .ww kill <nomor> — serigala membunuh\n• .ww seer <nomor> — peramal menerawang\n• .ww guard <nomor> — penjaga melindungi\n• .ww heal <nomor> / .ww poison <nomor> — aksi witch\n• .ww shoot <nomor> — tembakan balas dendam hunter\n• .ww lovers <nomor1> <nomor2> — cupid memilih pasangan\n• .ww peek — little girl mengintip\n• .ww convert <nomor> — alpha merubah penduduk\n• .ww vote <nomor> — vote menggantung\n• .ww lang <id|en> — ganti bahasa'
};
