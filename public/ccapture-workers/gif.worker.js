		...
		a.define('/GIFEncoder.js', function (e, h, i, j) {
			...
			((c.prototype.newPage = function () {
				...
				(c.prototype.getData = function () {
					var d = '';
					for (var a = 0; a < this.pages.length; a++) for (var b = 0; b < c.pageSize; b++) d += c.charMap[this.pages[a][b]];
					return d;
				}),
		...
		a.define('/LZWEncoder.js', function (e, g, h, i) {
			function f(y, D, C, B) {
				...
				function A(z, r) {
					var g, t, d, e, y, w, s;
					for (
						q = z, j = !1, n_bits = q, m = p(n_bits), i = 1 << (z - 1), o = i + 1, k = i + 2, f = 0, e = v(), s = 0, g = a;
						g < 65536;
						g *= 2
					)
						++s;
			...
			function C(A, B) {
				...
				function L(j, e, n, l, k) {
					...
					while (g < i || f > h)
						((d = z[m++]),
							g < i &&
								((b = o[g++]), (b[0] -= (d * (b[0] - n)) / c), (b[1] -= (d * (b[1] - l)) / c), (b[2] -= (d * (b[2] - k)) / c)),
							f > h &&
								((b = o[f--]),
								(b[0] -= (d * (b[0] - n)) / c),
								(b[1] -= (d * (b[1] - l)) / c),
