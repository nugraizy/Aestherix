			...
			return await client[botNum].sendMessage(
				from,
				{
					...
					templateButtons: [
						...
						index !== 0 ? { quickReplyButton: { displayText: 'Previous Image', id: `.stockimages prev ${data[index - 1]} ${JSON.stringify(data)}` } } : {},
					],
			...
			await client[botNum].sendMessage(
				from,
				{
					...
					templateButtons: [
						...
						{ quickReplyButton: { displayText: 'Next Image', id: `.stockimages next ${result[1]} ${JSON.stringify(result)}` } },
					],
